...
<script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script> <!-- 넣어줘야해.. -->
</head>
<body>
...
<script type="text/javascript">
	...
	*/
	...
	let deptno = inputDeptno.value;
    inputDeptno.addEventListener('blur', () => {
        axios.get('http://localhost:8081/api/dept/' + inputDeptno.value)
        	.then(response => {
