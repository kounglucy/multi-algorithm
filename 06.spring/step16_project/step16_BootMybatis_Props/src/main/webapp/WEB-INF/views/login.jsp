...
<script type="text/javascript">
	...
	const inputEmpno = document.getElementById('empno'); //객체생성?
	const empnoMsg = document.getElementById("empnoMsg"); //위에 아이디 두개 다 확인!!
	inputEmpno.addEventListener('blur', () => {
		axios.get('http://localhost:8081/api/emp/' + inputEmpno.value)
			.then(response => {
				console.log(response.data);
				if(response.data != null){
				empnoMsg.innerHTML = '존재하는 사원입니다. 로그인을 진행해주세요!';
			}
		})
		.catch(error => {
